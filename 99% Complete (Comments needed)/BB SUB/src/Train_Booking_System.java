...
public class Train_Booking_System extends Application {
    ...
    private void findSeat(){
        ...
        System.out.println(CustomerBookings.get(findName));
        System.out.println(CustomerId.get(findID));
    ...
    private void CustomerBookingFileWrite(HashMap<String, ArrayList<String>> hashMap, String filePath){
